...
Here are the trait ChainUtils is using :
...
"Benchmark" are simple method you can use or modify to measure performance of ChainUtils, they have some file system dependencies.
