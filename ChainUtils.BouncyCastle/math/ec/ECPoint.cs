...
namespace ChainUtils.BouncyCastle.Math.EC
{
        ...
        : AbstractFpPoint
    {
        ...
        protected virtual FpPoint TwiceJacobianModified(bool calculateW)
        {
            ...
            return new FpPoint(Curve, X3, Y3, new ECFieldElement[] { Z3, W3 }, IsCompressed);
        }
    }
...
//			F2mFieldElement.CheckFieldElements(a.x, b.x);
        ...
        /* (non-Javadoc)
         * @see ChainUtils.BouncyCastle.math.ec.ECPoint#add(ChainUtils.BouncyCastle.math.ec.ECPoint)
         */
        public override ECPoint Add(ECPoint b)
        {
            CheckPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see ChainUtils.BouncyCastle.math.ec.ECPoint#subtract(ChainUtils.BouncyCastle.math.ec.ECPoint)
         */
        ...
        /* (non-Javadoc)
         * @see ChainUtils.BouncyCastle.Math.EC.ECPoint#twice()
         */
        public override ECPoint Twice()
        {
            if (IsInfinity)
