    ...
    public class ECAlgorithms
    {
        ...
        */
        ...
        internal static ECPoint ImplSumOfMultiplies(ECPoint[] ps, BigInteger[] ks)
        {
            ...
            {
                var ki = ks[i]; negs[i] = ki.SignValue < 0; ki = ki.Abs();
        ...
        internal static ECPoint ImplSumOfMultiplies(ECPoint[] ps, ECPointMap pointMap, BigInteger[] ks)
        {
            ...
            for (var i = 0; i < halfCount; ++i)
            {
                ...
                var kj0 = ks[j0]; negs[j0] = kj0.SignValue < 0; kj0 = kj0.Abs();
                var kj1 = ks[j1]; negs[j1] = kj1.SignValue < 0; kj1 = kj1.Abs();
