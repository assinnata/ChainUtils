...
namespace ChainUtils.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            var Z1 = (SecP224K1FieldElement)RawZCoords[0];
            var Z2 = (SecP224K1FieldElement)b.RawZCoords[0];
        ...
        public override ECPoint Twice()
        {
            ...
            var Y1 = (SecP224K1FieldElement)RawYCoord;
            if (Y1.IsZero)
                return curve.Infinity;
