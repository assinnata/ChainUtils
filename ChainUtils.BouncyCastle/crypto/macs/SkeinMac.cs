...
namespace ChainUtils.BouncyCastle.Crypto.Macs
{
	...
	/// based on the <see cref="ChainUtils.BouncyCastle.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	/// <seealso cref="ChainUtils.BouncyCastle.Crypto.Digests.SkeinEngine"/>
		...
		: IMac
	{
		...
		/// </summary>
		/// See <see cref="ChainUtils.BouncyCastle.Crypto.Parameters.SkeinParameters"></see> for details on the parameterisation of the Skein hash function.
