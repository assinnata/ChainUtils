...
namespace ChainUtils.BouncyCastle.Crypto.Macs
{
        ...
        : IMac
    {
        ...
        /// <summary>
        /// Initialises the GMAC - requires a <see cref="ChainUtils.BouncyCastle.Crypto.Parameters.ParametersWithIV"/> 
        /// providing a <see cref="ChainUtils.BouncyCastle.Crypto.Parameters.KeyParameter"/> and a nonce.
        /// </summary>
