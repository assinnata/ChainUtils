...
namespace ChainUtils.BouncyCastle.Crypto.Digests
{
    ...
    /// sizes, based on the <see cref="ChainUtils.BouncyCastle.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
    /// </summary>
    /// <remarks>
    ...
    /// <p/>
    /// This implementation is the basis for <see cref="ChainUtils.BouncyCastle.Crypto.Digests.SkeinDigest"/> and <see cref="ChainUtils.BouncyCastle.Crypto.Macs.SkeinMac"/>, implementing the
    /// parameter based configuration system that allows Skein to be adapted to multiple applications. <br/>
    /// Initialising the engine with <see cref="ChainUtils.BouncyCastle.Crypto.Parameters.SkeinParameters"/> allows standard and arbitrary parameters to
    ...
    /// </ul>
    /// </remarks>
    /// <seealso cref="ChainUtils.BouncyCastle.Crypto.Parameters.SkeinParameters"/>
        ...
        : IMemoable
    {
        ...
        /// <summary>
        /// Initialises the Skein engine with the provided parameters. See <see cref="ChainUtils.BouncyCastle.Crypto.Parameters.SkeinParameters"/> for
