...
using ChainUtils.BouncyCastle.Math.EC.Custom.Djb;
...
namespace ChainUtils.BouncyCastle.Crypto.EC
{
    public sealed class CustomNamedCurves
    {
        ...
        {
            var holder = (X9ECParametersHolder)nameToCurve[Platform.ToLowerInvariant(name)];
