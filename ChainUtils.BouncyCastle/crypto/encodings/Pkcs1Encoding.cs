...
namespace ChainUtils.BouncyCastle.Crypto.Encodings
{
    ...
    */
        ...
        : IAsymmetricBlockCipher
    {
         ...
         * work with one of these set the system property ChainUtils.BouncyCastle.Pkcs1.Strict to false.
         */
        public const string StrictLengthEnabledProperty = "ChainUtils.BouncyCastle.Pkcs1.Strict";
